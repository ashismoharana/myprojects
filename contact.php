...
<html lang="en">
    <head>
        ...
        <title>zennvicartprimo - Contact Us</title>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-5 col-md-12">
                        <div class="contact-info">
                            <h3>Here to Help</h3>
                            <p>Have a question? You may find an answer. But you can also contact us.</p>

                            <ul class="contact-list">
                                <li><i class='bx bx-map'></i> Location: <a href="#">Wonder Street, USA, New York</a></li>
                                <li><i class='bx bx-phone-call'></i> Call Us: <a href="tel:+415 6021 3200">+415 6021 3200</a></li>
                                <li><i class='bx bx-envelope'></i> Email Us: <a href="mailto:info@zenvicartprimo.com">info@zenvicartprimo.com</a></li>
                                <li><i class='bx bx-microphone'></i> Fax: <a href="tel:+415 6021 3200">+415 6021 3200</a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-7 col-md-12">
                        <div class="contact-form">
                            ...
                            <p style="font-size: 14px;">If you have anu queries related to our products feel free to contact us to our team.</p>
